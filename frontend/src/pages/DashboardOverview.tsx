  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-150">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="p-6 rounded-xl bg-white border border-slate-200 hover:border-slate-300 transition-colors duration-150 shadow-sm flex flex-col justify-between">
          ...
          <div className="mt-3 space-y-1">
            ...
            <div className="flex items-center gap-1.5 text-xs sm:text-sm text-emerald-700 font-extrabold">
              <TrendingUp className="w-4 h-4 text-emerald-600" />
              <span>+18.4% growth this month</span>
            </div>
          </div>
          <div className="mt-3 h-2 w-full bg-slate-100 rounded-full overflow-hidden border border-slate-200">
        ...
        <div className="p-6 rounded-xl bg-white border border-slate-200 hover:border-slate-300 transition-colors duration-150 shadow-sm flex flex-col justify-between">
          ...
          <div className="mt-3 space-y-1">
            ...
            <div className="text-xs sm:text-sm text-slate-700 font-extrabold">
              35 Districts & Cities
            </div>
          </div>
          <div className="mt-3 h-2 w-full bg-slate-100 rounded-full overflow-hidden border border-slate-200">
        ...
        <div className="p-6 rounded-xl bg-white border border-slate-200 hover:border-slate-300 transition-colors duration-150 shadow-sm flex flex-col justify-between">
          <div className="flex items-center justify-between">
            ...
            <div className="p-2 rounded-lg bg-amber-50 border border-amber-200 text-amber-800 font-bold">
              <AlertTriangle className="w-4 h-4" />
            </div>
          </div>
          <div className="mt-3 space-y-1">
            <div className="text-3xl sm:text-4xl font-extrabold text-slate-950 tracking-tight font-mono">126</div>
            <div className="text-xs sm:text-sm text-amber-800 font-extrabold">
        ...
        <div className="p-6 rounded-xl bg-white border border-slate-200 hover:border-slate-300 transition-colors duration-150 shadow-sm flex flex-col justify-between">
          <div className="flex items-center justify-between">
            ...
            <div className="p-2 rounded-lg bg-rose-50 border border-rose-200 text-rose-800 font-bold">
          ...
          <div className="mt-3 space-y-1">
            ...
            <div className="text-xs sm:text-sm text-rose-800 font-extrabold flex items-center gap-1">
      ...
      <div className="p-6 rounded-xl bg-white border border-slate-200 space-y-5 shadow-sm text-slate-950 font-bold">
              ...
              >
                <div>
                  <div className="flex justify-between items-start mb-2">
                    <span className="text-sm sm:text-base font-extrabold text-slate-950 tracking-tight">{reg.district_city}</span>
                    <span className="text-xs font-mono font-extrabold px-2 py-0.5 rounded bg-white border border-slate-200 text-slate-700">
                      {reg.country_code}
                    </span>
                  </div>

                  <div className="text-2xl sm:text-3xl font-extrabold text-slate-950 font-mono tracking-tight mt-1">
                    {perCapita.toLocaleString()} <span className="text-xs text-slate-700 font-bold">/ 100k</span>
                  </div>

                  <div className="mt-3 space-y-1">
                    <div className="flex justify-between text-xs font-mono text-slate-700 font-bold">
                      <span>Density Meter</span>
                      <span className="text-indigo-700 font-extrabold">{densityPct}%</span>
                    </div>
                ...
                <div className="mt-4 pt-3 border-t border-slate-200 space-y-1 text-xs font-mono font-bold">
                  <div className="flex justify-between text-slate-700">
                    <span>Population:</span>
                    <span className="text-slate-950 font-extrabold">{reg.population.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between text-slate-700">
                    <span>Vulnerability:</span>
                    <span className="text-amber-800 font-extrabold">{reg.vulnerability_index.toFixed(2)}</span>
                  </div>
                </div>
              </button>
            );
        ...
        {selectedRegion && (
          <div className="p-4.5 rounded-xl bg-slate-50 border border-slate-200 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 text-xs sm:text-sm font-bold">
            <div className="flex items-center gap-3">
              <div className="p-2.5 rounded-lg bg-white text-indigo-700 border border-slate-200 shadow-2xs">
              ...
              <div>
                ...
                <p className="text-slate-700 text-xs sm:text-sm mt-0.5 font-mono font-bold">
                  Demographic Vulnerability: <strong className="text-amber-800 font-extrabold">{selectedRegion.vulnerability_index.toFixed(2)}</strong> • Primary Language: <strong className="text-indigo-700 font-extrabold">{selectedRegion.primary_language.toUpperCase()}</strong>
                </p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() => onNavigate('hotspots')}
                className="px-4 py-2 rounded-lg bg-white hover:bg-slate-100 border border-slate-300 text-slate-950 font-extrabold transition text-xs sm:text-sm flex items-center gap-1.5 cursor-pointer shadow-2xs"
              >
                <span>Hotspots</span>
      ...
      <div className="p-6 rounded-xl bg-white border border-slate-200 space-y-4 shadow-sm text-slate-950 font-bold">
        <div className="flex items-center justify-between border-b border-slate-200 pb-4">
          ...
          <span className="px-3 py-1.5 rounded-lg bg-slate-100 text-slate-900 border border-slate-200 text-xs font-mono font-extrabold">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-3">
          {[
            ...
            <div key={f.label} className="p-3 rounded-xl bg-slate-50 border border-slate-200 text-center space-y-1.5 shadow-2xs">
              <div className="text-xs font-extrabold text-slate-800 font-mono truncate">{f.label}</div>
              <div className="text-base sm:text-lg font-extrabold text-slate-950 font-mono">{f.weight}</div>
              <div className="h-2 w-full bg-slate-200 rounded-full overflow-hidden border border-slate-300">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 p-6 rounded-xl bg-white border border-slate-200 space-y-4 shadow-sm text-slate-950 font-bold">
          ...
          <div className="space-y-3">
            {topRecommendations.map((rec, index) => (
              <div
                key={rec.id}
                className="p-4 rounded-xl bg-slate-50 border border-slate-200 hover:border-slate-300 transition-colors duration-150 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-2xs"
              >
                <div className="flex items-start gap-3">
                  <span className="text-xs font-mono font-extrabold text-indigo-700 w-6 pt-0.5">
                    #{index + 1}
                  </span>
                  <div>
                    <div className="flex items-center gap-2">
                    ...
                    <div className="text-xs sm:text-sm text-slate-800 font-mono font-bold mt-0.5">{rec.region_name}</div>
                    <div className="text-xs sm:text-sm text-slate-800 mt-1 italic font-bold line-clamp-1">"{rec.reasoning}"</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 self-end sm:self-center">
                  ...
                  <button
                    ...
                    className="px-3.5 py-2 rounded-lg bg-white hover:bg-slate-100 border border-slate-300 text-slate-950 transition text-xs sm:text-sm font-extrabold flex items-center gap-1 cursor-pointer shadow-2xs"
                  >
        ...
        <div className="p-6 rounded-xl bg-white border border-slate-200 space-y-5 flex flex-col justify-between shadow-sm text-slate-950 font-bold">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <Network className="w-5 h-5 text-indigo-600 font-extrabold" />
            ...
            {featuredRec && (
              <>
                <div className="flex items-center justify-between mb-4 p-3.5 rounded-xl bg-slate-50 border border-slate-200 shadow-2xs">
                  <div>
                    <h4 className="text-sm sm:text-base font-extrabold text-slate-950">{featuredRec.category.toUpperCase()}</h4>
                    <span className="text-xs font-mono font-bold text-slate-700">{featuredRec.region_name}</span>
                  </div>
                ...
                <div className="space-y-3 relative before:absolute before:left-2 before:top-2 before:bottom-2 before:w-0.5 before:bg-slate-200 pl-5 text-xs sm:text-sm font-bold">
                  <div className="relative">
                    <span className="absolute -left-5 top-1 w-2.5 h-2.5 rounded-full bg-indigo-600" />
                    <div className="font-extrabold text-slate-950">14 Verified Citizen Signals</div>
                    <div className="text-xs text-slate-700 font-mono font-bold">High demand density logged</div>
                  </div>
                  <div className="relative">
                    <span className="absolute -left-5 top-1 w-2.5 h-2.5 rounded-full bg-amber-500" />
                    <div className="font-extrabold text-slate-950">Capacity Gap: 0.82 Deficit</div>
                    <div className="text-xs text-slate-700 font-mono font-bold">Baseline capacity deficit</div>
                  </div>
                  <div className="relative">
                    <span className="absolute -left-5 top-1 w-2.5 h-2.5 rounded-full bg-indigo-500" />
                    <div className="font-extrabold text-slate-950">Demand Velocity Trend</div>
                    <div className="text-xs text-slate-700 font-mono font-bold">+25% 30-day temporal change</div>
                  </div>
                  <div className="relative">
                    <span className="absolute -left-5 top-1 w-2.5 h-2.5 rounded-full bg-rose-600" />
                    <div className="font-extrabold text-rose-800">Priority Score: {featuredRec.priority_score.toFixed(1)}/100</div>
                    <div className="text-xs text-slate-700 font-mono font-bold">Fast-track allocation required</div>
                  </div>
                </div>
              </>
            )}
