...
class ScenarioSimulationService:
    ...
    def simulate_scenario(
        ...
        orig_score, _, _, _, _ = scoring_engine.calculate_priority_score(
            region=region,
            indicator=indicator,
            requests=requests,
        ...
        # $10M USD -> +15% coverage capacity addition
        ...
        sim_score, _, _, _, _ = scoring_engine.calculate_priority_score(
            region=region,
